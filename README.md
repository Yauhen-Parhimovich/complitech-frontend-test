Для логина не хватает в кэше каких-то данных. Посетите [эту страницу](https://213.184.245.66:5010/login), данные прикрепяться и API начнёт как положено работать.
